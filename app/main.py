...
async def handle_inbound_bank_webhook(payload: BankWebhookPayload, request: Request, x_bank_signature: str = Header(default="test_bypass_sig"), db: Session = Depends(get_db)):
    ...
    return {
        ...
        "platform_take_credited": payload.amount * take,
        "vendor_net_credited": payload.amount - (payload.amount * take),
...
def health_check():
    return {"status": "HEALTHY", "engine": "B2B_VIRTUAL_ACCOUNT_LEDGER_V6_1_CORS_ENABLED"}
